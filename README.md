...
This repository contains implementations of B-Tree and B+Tree.
...
distinct.
Instructions for B+Tree-
In B+Tree a guide is printed for all the operations expected from the user. Default value of ordwer is 4, minimum is 3 and maximum user can enter is 100.
